...
typedef struct entity {
	...
	geom::point pos;
	sf::Image texture;
	entity(entityType type_, geom::point pos_, sf::Image& texture_) {
		type = type_;
		pos = pos_;
		texture = texture_;
	}
	entity(entityType type_, geom::point pos_) {
		type = type_;
		pos = pos_;
	}
	entity() {
		entity(ITEM0, geom::point(1, 1));
	}
};


//We're going to reate a test entity here that we'll try to render.
...
// the future.
geom::line lWallsArray[24] = {
	geom::line(geom::point(7.16666666667, 30.3333333333),geom::point(17.0, 17.6666666667)),
	geom::line(geom::point(17.0, 17.6666666667), geom::point(29.1666666667, 23.5)),
	geom::line(geom::point(29.1666666667, 23.5), geom::point(41.0, 8.0)),
	geom::line(geom::point(41.0, 8.0), geom::point(48.1666666667, 23.1666666667)),
	geom::line(geom::point(48.1666666667, 23.1666666667), geom::point(59.3333333333, 18.3333333333)),
	geom::line(geom::point(59.3333333333, 18.3333333333), geom::point(76.5, 18.6666666667)),
	geom::line(geom::point(76.5, 18.6666666667), geom::point(76.5, 25.1666666667)),
	geom::line(geom::point(76.5, 25.1666666667), geom::point(70.3333333333, 33.8333333333)),
	geom::line(geom::point(70.3333333333, 33.8333333333), geom::point(72.5, 38.3333333333)),
	geom::line(geom::point(72.5, 38.3333333333), geom::point(84.0, 38.5)),
	geom::line(geom::point(84.0, 38.5), geom::point(87.8333333333, 52.3333333333)),
	geom::line(geom::point(87.8333333333, 52.3333333333), geom::point(87.5, 62.3333333333)),
	geom::line(geom::point(87.5, 62.3333333333), geom::point(80.5, 78.0)),
	geom::line(geom::point(80.5, 78.0), geom::point(61.3333333333, 76.0)),
	geom::line(geom::point(61.3333333333, 76.0), geom::point(43.0, 80.6666666667)),
	geom::line(geom::point(43.0, 80.6666666667), geom::point(36.6666666667, 68.8333333333)),
	geom::line(geom::point(36.6666666667, 68.8333333333), geom::point(21.8333333333, 73.3333333333)),
	geom::line(geom::point(21.8333333333, 73.3333333333), geom::point(24.1666666667, 80.8333333333)),
	geom::line(geom::point(24.1666666667, 80.8333333333), geom::point(18.3333333333, 86.8333333333)),
	geom::line(geom::point(18.3333333333, 86.8333333333), geom::point(14.6666666667, 83.8333333333)),
	geom::line(geom::point(14.6666666667, 83.8333333333), geom::point(14.5, 76.8333333333)),
	geom::line(geom::point(14.5, 76.8333333333), geom::point(20.8333333333, 68.5)),
	geom::line(geom::point(20.8333333333, 68.5), geom::point(27.3333333333, 46.3333333333)),
	geom::line(geom::point(27.3333333333, 46.3333333333), geom::point(7.16666666667, 30.3333333333))
};
int n = 24;
//****************
